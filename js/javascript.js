...
let array_2 = [{
    ...
    },
    {
        ...
        answers: [
            ...
            "Chỉ được vận chuyển khi đã chằng uộc bcẩn thận.",
...
let array_3 = [{
    ...
    {
        question: "TNgười lái xe mô tô xử lý như thế nào khi cho xe mô tô phía sau vượt?",
        image: " ",
        answers: [
    ...
    {
        question: "Người lái xe phải giảm tốc độ thấp hơn tốc độ tối đa cho phép đến mức cần thiết, chú ý quan sát và chuẩn bị sẵn sàng những tình huống có thế xảy ra để phòng ngừa tai nạn trong các trường hợp nào dưới đây?",
        image: " ",
        answers: [
...
let array_5 = [{
    ...
    },
    {
        ...
        answers: [
            ...
            "Được vượt khi đảm bảo an toàn.Chở người ngồi sau dưới 16 tuổi."
            //4
...
let array_6 = [{
    ...
    {
        question: "* * Người có GPLX mô tô hạng A1 không được phép điều khiển loại xe nào dưới đây?",
        image: " ",
        answers: [
    ...
    {
        question: "BBạn đang lái xe trên đường hẹp, xuống dốc và gặp một xe đang đi lên dốc, bạn cần làm gì?",
        image: " ",
        answers: [
    ...
    {
        question: "Biển nào báo hiệu “Nơi đỗ xe dành cho người tàn tật”?",
    ...
    },
    {
        ...
        image: "https://hoclaixemoto.com/image200/189.jpg",
        answers: [
            "Cho phép.",
            "Không được vượt."
            //24
    ...
    },
    {
        ...
        image: "https://hoclaixemoto.com/image200/197.jpg ",
        answers: [
...
const synthetic = [array_1, array_2, array_3, array_4, array_5, array_6, array_7, array_8];
let exam = [],
    score = 0,
    answerArray = [],
    current = 0,
